 ...
 */ function S(t) {
    ...
    if (A.logLevel <= c.DEBUG) {
        var r = e.map(R);
        A.debug.apply(A, _([ "Firestore (8.6.2): " + t ], r));
    }
}
...
function D(t) {
    ...
    if (A.logLevel <= c.ERROR) {
        var r = e.map(R);
        A.error.apply(A, _([ "Firestore (8.6.2): " + t ], r));
    }
}
...
function k(t) {
    ...
    if (A.logLevel <= c.WARN) {
        var r = e.map(R);
        A.warn.apply(A, _([ "Firestore (8.6.2): " + t ], r));
    }
}
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.at = function(t) {
        ...
        this.G.forEach((function(r, i) {
            ...
            if (o) {
                if (r.current && At(o.target)) {
                    ...
                    null !== e.H.get(s) || e.ut(i, s) || e.tt(i, s, bt.newNoDocument(s, t));
                }
                r.O && (n.set(i, r.M()), r.L());
            }
        }));
        ...
        return this.H = We(), this.J = cn(), this.Y = new Ge(F), i;
    }, 
    /**
 ...
 */ var Oi = function(t) {
    ...
    t.prototype.Ro = function() {
        return bi.fromInitialDocuments(this.query, this.fo, this.mutatedKeys, 0 /* Local */ === this.uo);
    }, t;
}(), Fi = function(
/**
     * The query itself.
...
function(t, e, n, r, i, o, s) {
    ...
    function t(t) {
        ...
        var n = function(t) {
            S("FirebaseCredentialsProvider", "Auth detected"), e.auth = t, e.lc(), e.auth.addAuthTokenListener(e.uc);
        };
        t.onInit((function(t) {
            return n(t);
        })), 
        ...
        setTimeout((function() {
            if (!e.auth) {
                ...
                // with null token
                S("FirebaseCredentialsProvider", "Auth not yet detected"), e.asyncQueue.enqueueRetryable((function() {
                    return e.changeListener(e.currentUser);
                })));
            }
        }), 0);
 ...
 */;
        ...
        get: function() {
            if (!this.ea) throw new I(T.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.ea;
        },
        enumerable: !1,
        configurable: !0
 ...
 */
    ...
    return g(e, t), e.prototype.convertBytes = function(t) {
        ...
        var e = this.convertDocumentKey(t, this.firestore._databaseId);
        return Iu.na(e, this.firestore, /* converter= */ null);
    }, e;
}(nu);
 ...
 */    }, t.prototype.onSnapshot = function() {
        ...
        return new t(this.firestore, e ? this._delegate.withConverter(Tu.sa(this.firestore, e)) : this._delegate.withConverter(null));
    }, t;
}();
...
var Du = /** @class */ function() {
    ...
    return g(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        return new e(this.firestore, t ? this._delegate.withConverter(Tu.sa(this.firestore, t)) : this._delegate.withConverter(null));
    }, e;
}(Ru);
...
//# sourceMappingURL=prebuilt-2d20097b-6bb6641b.js.map
