    ...
    constructor(t) {
        ...
        setTimeout((() => {
            if (!this.auth) {
                ...
                // with null token
                b("FirebaseCredentialsProvider", "Auth not yet detected"), this.asyncQueue.enqueueRetryable((() => this.changeListener(this.currentUser))));
            }
        }), 0);
    }
    getToken() {
...
//# sourceMappingURL=prebuilt.rn-e91f0771.js.map
